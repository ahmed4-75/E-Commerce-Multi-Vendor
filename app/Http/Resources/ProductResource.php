 ...
 *     @OA\Property(property="discount", type="number", example=2.60),
 ...
 *     @OA\Property(property="shop", description="Loaded only if relation shop is loaded", ref="#/components/schemas/ShopBasicResource"),
...
class ProductResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'shop' => $this->whenLoaded('shop',fn() => new ShopBasicResource($this->shop)),
